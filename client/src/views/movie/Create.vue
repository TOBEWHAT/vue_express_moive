        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="电影年份"
              ...
              <el-input type="number"
                        v-model="form.year"
                        placeholder="请输入电影年份"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="电影IMDB ID"
                          prop="imdb_id">
              <el-input v-model="form.imdb_id"
                        placeholder="请输入电影IMDB ID"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="电影海报"
              ...
              <el-input v-model="form.poster"
                        placeholder="请输入电影海报地址"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="24"
            ...
            <el-button type="warning"
                       @click="reset('movie-form')">重置</el-button>
          </el-col>
        </el-row>
      </el-form>
    </base-box>

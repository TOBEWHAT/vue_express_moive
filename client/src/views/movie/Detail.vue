  ...
  <base-box title="电影列表" type="primary">
    ...
    <div class="movie-item">
      ...
      <ul class="movie-meta">
        ...
        <li>
          <label class="text-info">编剧：</label> 饺子 / 易巧 / 魏芸芸
        </li>
        <li>
          <label class="text-info">类型：</label>
          {{ movie.genre }}
        </li>
        <li>
        ...
        <li>
          <label class="text-info">片长：</label> 110分钟
        </li>
        <li>
...
export default {
  ...
  created() {
    ...
    this.movie = {
      ...
      rating: 8.6,
      poster:
        'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1564896335887&di=518d13a5eeeffe27c80063b81b2a24da&imgtype=0&src=http%3A%2F%2Fimg.zcool.cn%2Fcommunity%2F015d965d395922a8012187f498949f.jpg%402o.jpg',
      description:
